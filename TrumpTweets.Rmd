...
library(tidyverse)
library(scales)
tweets = read_csv('DataForMD/tweets.csv')
clean_plot =  theme(axis.line = element_line(colour = "blue"), panel.grid.major = element_blank(),
                    panel.grid.minor = element_blank(), panel.border = element_blank(),
                    panel.background = element_blank(), legend.key = element_blank())
newtweets_data = read_csv('DataForMD/newtweets_data.csv')
clout = read_csv('DataForMD/clout.csv')
boxtable = read_csv('DataForMD/boxtable.csv')
extb = read_csv('DataForMD/extb.csv')
hashdf = read_csv('DataForMD/hashdf.csv')
tophash = read_csv('DataForMD/tophash.csv')
eff_hash = read_csv('DataForMD/eff_hash.csv')
```
